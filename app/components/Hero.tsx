...
const Hero: React.FC = () => {
    ...
    <section className='pt-20 relative text-center flex items-center justify-center bg-cover bg-center h-96 w-full bg-gray-900 bg-gradient-to-b from-green-900/50 to-transparent'>
       ...
       <div className='relative z-10 text-white p-4 md:p-8'>
          <h1 className={`${Noto.className} text-3xl md:text-5xl font-bold`}>
...
<button className="border-2 border-green-500 hover:scale-105 transition-all px-3 rounded-md py-2 text-green-400 my-4 text-xl">Explore</button>
       </div>
    </section>
    );
};
