...
export default function Navbar() {
  ...
  return (
    <div className="bg-transparent backdrop-blur-sm border-b border-black fixed z-20 w-full">
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-black hover:text-blue-700"
                    >
                      {item.name}
                    </Link>
                  ))}
